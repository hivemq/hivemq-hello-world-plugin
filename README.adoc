...
* Read about the available HiveMQ callbacks {hivemq-callbacks-overview-link}[here]. footnote:[There are also low level protocol callbacks available. See {github-low-level-callbacks}[https://github.com/hivemq/hivemq-spi/tree/master/src/main/java/com/dcsquare/hivemq/spi/callback/lowlevel]]
